...
export const dataAPI = {
	...
	findElectorRegister: async (data) => {
		try {
	...
	findDoubleElectorRegister: async (data) => {
		try {
	...
	fetchPhotoBase64: async (data, urlBy="byelector") => {
		try {
			const urlList = {
	...
	fetchFingerBase64: async (data, urlBy="byelector") => {
		try {
			const urlList = {
