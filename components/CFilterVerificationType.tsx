...
import { LIST_VERIFICATION_STATUS } from "@/constants/general";
import { Ionicons } from "@expo/vector-icons";

const CFilterVerificationType = ({ selectedVerificationType, setSelectedVerificationType }) => {
	const handleAction = {
	...
	return (
		<View className="px-4 bg-blue">
			<ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap: 5 }}>
				{LIST_VERIFICATION_STATUS.map((item, index) => {
...
export default CFilterVerificationType;
